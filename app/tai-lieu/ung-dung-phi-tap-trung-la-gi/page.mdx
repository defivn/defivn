...
## Thông tin mạng Manta Pacific

| Tên | Giá trị |
|:---|:---|
| Tên mạng | Manta Pacific L2 |
| Mô tả | The public mainnet for Manta Pacific |
| URL mạng | https://pacific-info.manta.network/ |
| URL Explorer | https://pacific-explorer.manta.network/ |
| URL RPC | https://manta-pacific.drpc.org |
| Chain ID | 169 |
| Ký hiệu tiền tệ | ETH |
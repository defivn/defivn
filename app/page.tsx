  ...
  return (
    <div className="space-y-6">
      ...
      <p className="leading-7 [&:not(:first-child)]:mt-6">
        <Link href="/" className="inline-block underline underline-offset-4 text-blue-500 dark:text-blue-400">DeFi.vn</Link> là một trang web tài liệu về tài chính phi tập trung (DeFi).
      ...
      <h2 className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0">Định nghĩa</h2>
      ...
      <h2 className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0">Các hệ sinh thái</h2>
      <div className="flex flex-col gap-2">
        {
      ...
      <h2 className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0">Ứng dụng</h2>
      <div className="flex flex-col gap-2">
        {
      ...
      <h2 className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0">Hướng dẫn</h2>
      <div className="flex flex-col gap-2">
        {
          posts.find((post) => post.section === "Hướng dẫn")?.posts.map((post) => (
            <div key={post.id} className="flex flex-row items-center gap-2">
              <h3 className="text-sm font-semibold bg-muted p-2 rounded-full w-8 h-8 flex items-center justify-center">{post.id}</h3>
              <Link className="font-medium underline underline-offset-4 text-blue-500 dark:text-blue-400 w-fit" href={post.url}>
                {post.title}
